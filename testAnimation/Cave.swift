...
class Cave: GameScene, Generation {
    ...
    func generateSeed(){
        if seed.count < 4 {
            seed.append(Int(arc4random_uniform(9) + 2)) //Room
            //        seed.append(3)
            
            //        seed.append(Int(arc4random_uniform(10))) //Interior
            seed.append(3)
            
            seed.append(Int(arc4random_uniform(4) + 1)) //Enemy Configuration
            //        seed.append(3)
            
            seed.append(Int(arc4random_uniform(9) + 2)) //Doors
            //        seed.append(3)
    ...
    func generateRoom(seed:[Int]){
        ...
        if !rooms.contains(room) && clearCount == 8 {
